...
const OUTER_PAD = 14;    // separación entre el pill y donde empieza la curva
const CURVE_SPAN = 46;   // qué tan "larga" es la diagonal
const FLAT_PATH = "M 0,0 L 1,0 L 1,1 L 0,1 Z"; // header plano, sin muesca, para cuando no hay Nav visible
...
export default function Header() {
    ...
    return (
        <>
            ...
            {/* Contenedor principal con drop-shadow */}
            <div
                ref={headerRef}
            ...
            >
                <motion.header
                    ...
                    style={{
                        clipPath: "url(#continuous-trapezoid)",
                    }}
                ...
                >
                    ...
                    {/* AUTH (desktop) + HAMBURGUESA (móvil) */}
