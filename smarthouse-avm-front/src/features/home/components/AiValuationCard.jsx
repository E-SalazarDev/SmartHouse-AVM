...
const FACTORS = [
    {
        ...
        icon: Maximize2,
        value: "159 m²",
        accent: { bg: "#eef2ff", ring: "#c7d2fe", icon: "#4f46e5" }, // indigo
    },
    {
        key: "habitaciones",
        label: "Habitaciones",
        icon: BedDouble,
        value: "3 cuartos",
        accent: { bg: "#faf5ff", ring: "#e9d5ff", icon: "#9333ea" }, // purple
    },
    {
        key: "garaje",
        label: "Garaje",
        icon: Warehouse,
        value: "2 autos",
        accent: { bg: "#eff6ff", ring: "#bfdbfe", icon: "#2563eb" }, // blue
    },
    {
        key: "calidad",
        label: "Calidad",
        icon: Hammer,
        value: "7 / 10",
        accent: { bg: "#fff7ed", ring: "#fed7aa", icon: "#ea580c" }, // orange
    },
    {
        key: "ubicacion",
        label: "Ubicación",
        icon: MapPin,
        value: "Ames, IA",
        accent: { bg: "#ecfdf5", ring: "#a7f3d0", icon: "#059669" }, // emerald
    },
    {
        key: "banos",
        label: "Baños",
        icon: Bath,
        value: "2 completos",
        accent: { bg: "#fdf2f8", ring: "#fbcfe8", icon: "#db2777" }, // pink
    },
];
...
export default function AiValuationCard() {
    return (
        <div className="relative h-full rounded-3xl border border-slate-200 bg-white p-5.5 flex flex-col overflow-hidden">
            ...
            >
                <div
                    className="w-13 h-13 rounded-full flex items-center justify-center shrink-0 border border-white/25"
            ...
            <div className="flex-1 grid grid-cols-2 gap-2.5">
                {FACTORS.map(({ key, label, icon: Icon, value, accent }) => (
                    <div
                        key={key}
                        className="rounded-2xl flex flex-col items-center justify-center text-center gap-1.5 px-3 py-4 transition-colors"
                        style={{
                    ...
                    >
                        <div
                            ...
                            style={{ background: "#ffffff", boxShadow: `0 0 0 1px ${accent.ring}` }}
                        >
